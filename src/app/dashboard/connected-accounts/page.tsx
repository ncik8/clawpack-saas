    ...
    <div className="p-8">
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-[#9ca3af] mt-1">Manage your social media accounts</p>
        </div>
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  {platform.connected ? (
                    <p className="text-sm text-[#10b981]">{platform.username}</p>
                  ) : (
              ...
              <div className="flex items-center gap-3">
                {platform.connected ? (
                  <>
                    ...
                    <button className="btn btn-ghost text-sm text-[#ef4444]">Remove</button>
                  </>
                ) : (
      ...
      <div className="mt-8 p-4 rounded-lg bg-[#1780e3]/10 border border-[#1780e3]/30">
        <p className="text-sm text-[#1780e3]">
          <strong>💡 Tip:</strong> Connecting multiple platforms allows you to post to all of them from one place. 
          Each platform will be authorized securely through OAuth.
        </p>
      </div>
    </div>
  );
