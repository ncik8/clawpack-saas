...
export default function ResearchPrompts() {
  ...
  useEffect(() => {
    fetch('https://clawpack.net/wp-json/wp/v2/pages/2074')
      .then(res => res.json())
      .then(data => {
    ...
    <main className="font-sans bg-white min-h-screen">
      <header className="bg-gradient-to-r from-[#083056] to-[#1780e3] text-white py-16 px-8">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-xl text-white/90">AI prompts for market research, competitor analysis, and data synthesis.</p>
        </div>
      </header>
